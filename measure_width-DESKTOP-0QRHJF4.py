...
def  sidewalk_connect():
    ...
    while len(measure_list) > 0:
        try:
            ...
            continue
    df_sidewalk_seg.to_csv(r'E:\USC_OneDrive\OneDrive - University of South Carolina\Research\sidewalk_wheelchair\results\sidewalks.csv', index=False)
    gdf = gpd.GeoDataFrame(df_sidewalk_seg, geometry=lines)
    gdf.to_file(r'E:\USC_OneDrive\OneDrive - University of South Carolina\Research\sidewalk_wheelchair\results\sidewalks.shp')
...
if __name__ == "__main__":
    ...
    DOM_to_shapefile_mp(DOM_dir=r"K:\OneDrive_USC\OneDrive - University of South Carolina\Research\sidewalk_wheelchair\DC_DOMs", class_idxs=[8, 12], saved_path=r"K:\OneDrive_USC\OneDrive - University of South Carolina\Research\sidewalk_wheelchair\DC_DOMs_shapefiles")